...
public class HandbookSafety extends AppCompatActivity {
    ...
    public void openProfileDialog(View view){
        AlertDialog.Builder profileDialog = new AlertDialog.Builder(HandbookSafety.this);
        ...
        profileDialog.setAdapter(adapter, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                switch (which){
                    case 0:{
                        Intent intent = new Intent(HandbookSafety.this, ProfileUser.class);
                        startActivity(intent);
                        break;
                    }
                    case 1:{
                        Intent intent = new Intent(HandbookSafety.this, ProfileVehicle.class);
                        startActivity(intent);
                        break;
                    }
                    case 2:{
...
//                            startActivity(intent);
        ...
        profileDialog.setNegativeButton("Sign Out", (v, a) -> {
            Intent intent = new Intent (HandbookSafety.this, Login.class);
            startActivity(intent);
