...
public class Handbook extends AppCompatActivity {
    ...
    public void openProfileDialog(View view){
        AlertDialog.Builder profileDialog = new AlertDialog.Builder(Handbook.this);
        ...
        profileDialog.setAdapter(adapter, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                switch (which){
                    case 0:{
                        Intent intent = new Intent(Handbook.this, ProfileUser.class);
                        startActivity(intent);
                        break;
                    }
                    case 1:{
                        Intent intent = new Intent(Handbook.this, ProfileVehicle.class);
                        startActivity(intent);
                        break;
                    }
                    case 2:{
                        Intent intent = new Intent(Handbook.this, ProfileInsurance.class);
                        startActivity(intent);
                        break;
                    }
                    case 3:{
                        Toast.makeText(Handbook.this, "Access User Reports", Toast.LENGTH_LONG).show();
...
//                            startActivity(intent);
        ...
        profileDialog.setNegativeButton("Sign Out", (v, a) -> {
            Intent intent = new Intent (Handbook.this, Login.class);
            startActivity(intent);
